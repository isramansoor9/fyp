...
export default function Course3() {
  ...
  const courseModules = [
    ...
    {
      no: 14,
      component: "Electronically Controlled vehicle systems and sensors",
      theory: 21,
      practical: 183,
      total: 204,
    },
    {
      no: 15,
      component: "Heating, Ventilating and Air Conditioning system",
      theory: 15,
      practical: 120,
      total: 135,
    },
  ...
  const skillProficiencyItems = [
    {
      en: "Use the hand tools, measuring tools, and electrical tools accordingly and safely. Check and maintain the battery.",
      ur: "ہینڈ ٹولز، پیمائشی اور برقی اوزار محفوظ اور مناسب طریقے سے استعمال کرے۔ بیٹری چیک اور دیکھ بھال کرے۔",
    },
    {
      en: "Inspect, dismantle, assemble, and performance-check the self-starter.",
      ur: "سیلف سٹارٹر کی جانچ، کھولنا، جمع کرنا اور کارکردگی کا معائنہ کرے۔",
    },
    {
      en: "Inspect, dismantle, assemble, and output-check the alternator.",
      ur: "الٹرنیٹر کی جانچ، کھولنا، جمع کرنا اور آؤٹ پٹ چیک کرے۔",
    },
    {
      en: "Make the wiring of various systems of the vehicle.",
      ur: "گاڑی کے مختلف نظاموں کی وائرنگ بنائے۔",
    },
    {
      en: "Check and troubleshoot the components of EFI.",
      ur: "EFI کے پرزوں کی جانچ اور خرابی دور کرے۔",
    },
    {
      en: "Inspect and troubleshoot the HVAC system of the vehicle.",
      ur: "گاڑی کے HVAC سسٹم کا معائنہ اور خرابی دور کرے۔",
    },
  ];
  ...
  const knowledgeProficiencyItems = [
    {
      ...
      ur: "بجلی، الیکٹرانکس اور اس پیشے سے متعلق اصطلاحات کی وضاحت کرے۔",
    },
    {
      en: "Explain the purpose, function, construction, and operation of the battery.",
      ur: "بیٹری کا مقصد، کام، ساخت اور طریقۂ کار بیان کرے۔",
    },
    {
      en: "Describe the purpose, function, construction, and operation of the self-starter.",
      ur: "سیلف سٹارٹر کا مقصد، کام، ساخت اور طریقۂ کار بیان کرے۔",
    },
    {
      en: "Describe the purpose, function, construction, and operation of alternators.",
      ur: "الٹرنیٹرز کا مقصد، کام، ساخت اور طریقۂ کار بیان کرے۔",
    },
    {
      en: "Define the purpose, function, construction, operation, and types of voltage regulators.",
      ur: "ولٹیج ریگولیٹرز کا مقصد، کام، ساخت، عمل اور اقسام بیان کرے۔",
    },
    {
      en: "Define the purpose, function, construction, operation, and types of ignition systems.",
      ur: "اگنیشن سسٹمز کا مقصد، کام، ساخت، عمل اور اقسام بیان کرے۔",
    },
    {
      en: "Explain the purpose, function, construction, and operation of various electrical components used in a car (horn, lights, windshield wipers, meters and gauges, etc.).",
      ur: "کار میں استعمال ہونے والے مختلف برقی پرزوں (ہارن، لائٹیں، وائپر، میٹر وغیرہ) کا مقصد، کام، ساخت اور طریقۂ کار بیان کرے۔",
    },
    {
      en: "Explain the operation of EFI, electric, and fuel injection circuits.",
      ur: "EFI، برقی اور فیول انجیکشن سرکٹس کا طریقۂ کار بیان کرے۔",
    },
    {
      en: "Explain the operation of electronic ignition.",
      ur: "الیکٹرانک اگنیشن کا طریقۂ کار بیان کرے۔",
    },
    {
      en: "Describe the operation of air conditioners in the vehicle.",
      ur: "گاڑی میں ائیر کنڈیشنرز کا طریقۂ کار بیان کرے۔",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 p-5 sm:p-8 lg:p-12">
            <div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-gray-900 leading-tight">
                ...
                <span className="block text-gray-500 text-xl font-medium mt-2">
                  {urdu ? "کورس 3 (1 سال کا دورانیہ)" : "Course 3 (1-Year Duration)"}
                </span>
              </h1>

              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                {urdu
                  ? "آٹوموٹیو ٹیکنالوجی میں الیکٹرانکس اور تیز ماڈل تبدیلیوں کے ساتھ ماہر آٹو الیکٹریشنز کی مانگ بڑھ رہی ہے۔ یہ کورس نظری بنیادوں کو گہری عملی تربیت سے جوڑتا ہے۔"
            ...
            <div className="bg-[#f4f3f2] rounded-xl p-8 border border-[#c3bebb]/30">
              <h3 className="text-2xl font-bold mb-6 text-gray-900">
                {urdu ? "کریکولم کی جھلک" : "Curriculum Salients"}
              </h3>
                ...
                {[
                  {
                    ...
                    label: urdu ? "داخلہ لیول" : "Entry Level",
                    val: urdu ? "میٹرک" : "Matric",
                  },
                  {
                    icon: <Calendar className="w-5 h-5" />,
                    label: urdu ? "کل دورانیہ" : "Total Duration",
                    val: urdu ? "1 سال (2 سمسٹر)" : "1 Year (2 Semesters)",
                  },
                  {
                    icon: <Globe className="w-5 h-5" />,
                    label: urdu ? "زبانِ تدریس" : "Instruction Medium",
                    val: "Urdu / English",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-4 bg-white rounded-lg shadow-sm border-l-4 border-[#c3bebb]"
                  >
        ...
        <div className={courseContentPanelClass}>
          <div className="p-7 md:p-9">
            <h3 className="text-2xl font-bold text-gray-900 mb-5">
              {urdu ? "تربیتی مقاصد" : "Training objectives"}
            </h3>
            <div className="space-y-4 text-lg leading-relaxed text-gray-600">
              {urdu ? (
                <>
                  <p>
                    گاڑیوں کی مقبولیت کی وجہ سے ہنر مند ٹیکنیشن کی ضرورت بڑھ گئی ہے اور یہ مہارت کی خصوصیت کا دور
                    ہے؛ ماڈلوں کی سالانہ تبدیلی اور الیکٹرانکس کی آمد ایسے آٹو الیکٹریشنز مانگتی ہے جنہیں نظری
                    بنیادوں کا علم ہو اور وہ عمل میں لا سکیں۔
                  </p>
                  <p>
                    اس کورس کی تجدید میں EFI، الیکٹرانک اگنیشن، ABS اور ائیر کنڈیشنگ جیسے نئے نظام شامل کیے گئے
                    ہیں تاکہ تربیت حاصل کرنے والا میدان میں دشواری محسوس نہ کرے۔
                  </p>
                  <p>
                    یہ نصاب آٹوموٹو کے سائنسی اصطلاحات، اصول، کام، ساخت اور نظام/پرزوں کے ورژن و اقسام، ٹربل
                    شوٹنگ اور اخلاقی اقدار کو شامل کرتا ہے تاکہ فارغ التحصیل جاب مارکیٹ کی ضروریات پوری کر
                    سکیں۔
                  </p>
                </>
              ) : (
                <>
                  <p>
                    Due to the popularity of automobiles, the need for skilled technicians has increased, and this is
                    an age of specialization. Rapid yearly model changes and the introduction of electronics require
                    auto electricians who have a sound theoretical foundation and can apply their knowledge in practice.
                  </p>
                  <p>
                    During the revision of this course, topics on newer systems such as EFI, electronic ignition, ABS,
                    and air conditioning have been introduced so that the trainee or initial learner may not face
                    problems in the field.
                  </p>
                  <p>
                    This curriculum covers automobile topics in scientific terms, principles, function, construction,
                    and operation of systems and parts, versions and types, and troubleshooting, together with ethical
                    values, enabling pass-outs to meet job market requirements.
                  </p>
                </>
              )}
            </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {courseModules.map((module, index) => (
                    <tr
                      key={index}
                      className={`border-b border-gray-300/40 last:border-b-0 ${
                        index % 2 === 0 ? "bg-[#f5f4f3]" : "bg-[#e8e4e2]"
                      }`}
                    >
      ...
      <section className="px-6 py-16 max-w-7xl mx-auto">
        <div className="bg-[#c3bebb] text-black rounded-3xl p-12 text-center shadow-2xl shadow-[#c3bebb]/40 relative overflow-hidden">
          ...
          <h2 className="text-4xl font-bold mb-4">
            {urdu ? "اپنا ٹیکنیکل کیریئر شروع کریں" : "Start Your Technical Career"}
          </h2>
