...
export default function ContentLoader({ urdu = false }: { urdu?: boolean }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden select-none bg-gradient-to-b from-white via-gray-50 to-white">
